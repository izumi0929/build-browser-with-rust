...
mod tests {
    ...
    fn test_url_host_port_path() {
        ...
        let expected = Ok(Url {
            url: "http://example.com:8080/index.html".to_string(),
            host: "example.com".to_string(),
            port: "8080".to_string(),
    ...
    fn test_url_host_path_searchpart() {
        let url = "http://example.com/index.html?search=example&b=456".to_string();
        let expected = Ok(Url {
            url: "http://example.com/index.html?search=example&b=456".to_string(),
            host: "example.com".to_string(),
            port: "80".to_string(),
            path: "index.html".to_string(),
            searchpart: "search=example&b=456".to_string(),
        });
        assert_eq!(Url::new(url).parse(), expected);
    }
